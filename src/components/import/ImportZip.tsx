...
export function ImportZip({
  ...
  return (
    ...
    >
      ...
      <p className="text-sm font-medium text-foreground">Unggah file .ZIP</p>
      <p className="text-xs text-muted-foreground">
        atau <span className="font-medium text-primary">klik untuk pilih ZIP</span>
      </p>
      <p className="text-[11px] text-muted-foreground">
        Ekstraksi disimulasikan otomatis
      </p>
      <input
        ref={ref}
        type="file"
